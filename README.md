...
Magisk / KernelSU-Next модуль для автоматической установки и обновления **Keybox** и **target.txt** для [TrickyStore](https://github.com/5ec1cff/TrickyStore), с удобным WebUI для управления всеми функциями без консоли.
...
1. Скачайте последний `.zip` со страницы [Releases](https://github.com/jjiijijj6464/MyModule-RedTeam/releases/)
...
Актуальный список изменений — на странице [Releases](https://github.com/jjiijijj6464/MyModule-RedTeam/releases/).
...
- Telegram-канал: [t.me/REDTEAMMANAGERR](https://t.me/REDTEAMMANAGERR)
- Баги и предложения: [Issues](https://github.com/jjiijijj6464/MyModule-RedTeam/issues)
